...
export function VendorEditForm({
  ...
  async function onSubmit(values: z.infer<typeof vendorFormSchema>) {
    ...
    try {
      ...
      console.log("Mise à jour du vendeur:", { id: vendor.id, ...values })

      // Simuler une requête API
      await new Promise((resolve) => setTimeout(resolve, 1000))

      toast({
        title: "Vendeur mis à jour avec succès",
      ...
      toast({
        ...
        description: "Impossible de mettre à jour le vendeur. Veuillez réessayer.",
        variant: "destructive",
      })
    } finally {
      setIsLoading(false)
